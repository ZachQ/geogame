...
/**
 * A container class that holds scoreboard data. Used in
 * ScoreboardboardTabActivity.
 * 
 */
public class ScoreboardDataContainer {
	...
	public int totalCosts() {
		return landBuyCost + seedBuyCost + fertilizerBuyCost + waterBuyCost
				+ laborBuyCost + oxenBuyCost;
	}
